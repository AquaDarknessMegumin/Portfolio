...
export function Experiences() {
    const experiences = [
        ...
        },
        {
            ...
            icon: <BookOpen size={22} className="text-foreground/60" />,
            highlight: false,
        },
        {
            id: 4,
        ...
        <section id="experiences" className="py-28 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 max-w-4xl relative z-10">
                ...
                <div className="relative">
                    {/* Timeline Line */}
                    <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-primary-500/30 via-foreground/10 to-transparent md:-translate-x-1/2" />
                        ...
                        {experiences.map((exp, index) => (
                            ...
                            >
                                ...
                                <div className={`w-full md:w-1/2 ml-16 md:ml-0 ${index % 2 === 0 ? "md:pl-14" : "md:pr-14 text-left md:text-right"
                                    ...
                                    <div className={`p-6 rounded-2xl glass-card transition-all duration-300 group hover:border-foreground/15 ${exp.highlight ? "border-primary-500/15" : ""
                                        }`}>
                                        <div className={`flex items-center gap-2 mb-2 text-xs font-semibold uppercase tracking-wider ${exp.highlight ? "text-primary-500" : "text-foreground/40"
                                            } ${index % 2 !== 0 ? "md:justify-end" : ""}`}>
                                            <Calendar size={14} />
                                            <span>{exp.date}</span>
                                        </div>
                                        <h3 className="text-lg font-medium text-foreground mb-1 group-hover:text-primary-400 transition-colors leading-snug tracking-tight">
                                            {exp.title}
                                        </h3>
