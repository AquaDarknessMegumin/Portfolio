...
import { ArrowRight, MapPin, Code2, GraduationCap } from "lucide-react";
            ...
            <div className="container mx-auto px-6 max-w-[1200px] relative z-10">
                ...
                >
                    <div className="flex flex-col md:flex-row">
                        {/* Profile Image */}
                        <div className="w-full md:w-2/5 relative min-h-[350px] md:min-h-[450px] overflow-hidden group">
                            <Image
                        ...
                        <div className="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center">
                            ...
                            <div className="flex flex-wrap gap-3 mb-8">
                                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-foreground/5 border border-foreground/8 text-foreground/60 text-xs font-medium">
