            ...
            <div className="container mx-auto px-6 max-w-7xl relative z-10">
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="text-center md:text-left">
                        <Link href="/" className="text-2xl font-bold tracking-tighter text-foreground inline-block mb-2">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="w-10 h-10 rounded-xl glass-card flex items-center justify-center text-foreground/50 hover:text-secondary-400 hover:border-secondary-500/30 transition-all duration-300 hover:-translate-y-1"
                        >
                            <FaFacebook size={18} />
                        </a>
                        <a
